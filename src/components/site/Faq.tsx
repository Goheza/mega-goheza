...
const data: Record<Audience, { groups: Group[]; advisor: { name: string; role: string; tagline: string }; cta: string }> = {
  brands: {
    ...
    groups: [
      {
        ...
        items: [
          { q: "How does Goheza work for brands?", a: "You brief your goals, budget, and creative dos/don'ts. Vetted creators apply with ready-to-post content. You approve what fits and only pay on attributed performance." },
          { q: "How do I create a campaign?", a: "From your dashboard, click New Campaign, add a brief and assets, set a payout per 1,000 views and a total budget, then publish. Most campaigns go live in under 30 minutes." },
          { q: "How are creators selected?", a: "Every creator is vetted for audience quality, engagement, and prior performance. You can filter by niche, platform, region, and historical CPM." },
        ],
      },
      {
        label: "Pricing & performance",
        items: [
          { q: "How does performance-based payment work?", a: "You set a payout rate (e.g. $8 per 1,000 attributed views). Creators only earn when content actually performs. You stop paying when the cap is hit." },
          { q: "Is there a minimum campaign budget?", a: "Pilot campaigns start at $1,000. Most performance-marketing teams run between $5K and $50K per campaign to gather statistically significant data." },
          { q: "How do I track campaign performance?", a: "A live dashboard shows views, watch-time, CTR, installs, and revenue per creator. Export to your BI stack or pipe via webhook to your warehouse." },
        ],
      },
      {
        label: "Platforms & launch",
        items: [
          { q: "What social platforms are supported?", a: "TikTok, Instagram Reels, YouTube Shorts, and X — with attribution and creator-level analytics on each." },
          { q: "How quickly can my campaign go live?", a: "First creator applications typically arrive within 4 hours. Most campaigns have approved content going live the same day you brief them." },
        ],
      },
    ],
  },
  creators: {
    ...
    groups: [
      {
        label: "Joining Goheza",
        items: [
          { q: "How do I join Goheza?", a: "Sign up with your TikTok or Instagram, complete a short profile, and our team reviews your account within 24 hours. Most active creators get approved." },
          { q: "How do I apply for campaigns?", a: "Browse active briefs, pick the brands you'd actually post about, and submit a short content idea or a finished draft. No cold pitching required." },
          { q: "How do I get approved?", a: "Brands review your submission and either approve, request a tweak, or decline. You get feedback either way — usually within 24 hours." },
        ],
      },
      {
        label: "Earnings & payouts",
        items: [
          { q: "How do I earn money?", a: "Once your content is approved and live, you earn for every 1,000 attributed views it generates. The more your video performs, the more you earn." },
          { q: "How is payment calculated?", a: "Each brief publishes a clear payout per 1,000 views (CPM). Your earnings = (views ÷ 1,000) × CPM. No hidden cuts, no surprise deductions." },
          { q: "When do I receive my earnings?", a: "Payouts run weekly. Once your balance crosses the minimum threshold, the funds hit your account in 24–48 hours." },
        ],
      },
      {
        label: "Platforms & freedom",
        items: [
          { q: "Which social media platforms are supported?", a: "TikTok, Instagram Reels, YouTube Shorts, and X. Pick the ones you already create on — no need to start a new account." },
          { q: "Do I choose which campaigns to join?", a: "Always. You'll never be auto-assigned. Pick the brands that match your voice and skip the rest, no penalty." },
        ],
      },
    ],
  },
  ...
  return (
    <section id="faq" className="relative overflow-hidden py-16 sm:py-24">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        {/* Body */}
        <div ref={bodyRef} className="reveal-scale mt-12 grid gap-8 lg:grid-cols-[360px_1fr] lg:gap-14">
          <AdvisorCard advisor={variant.advisor} cta={variant.cta} audience={audience} />
      ...
      <div className="group relative overflow-hidden rounded-[22px] border border-hairline shadow-card transition-transform duration-500 hover:-translate-y-1">
        ...
        >
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle at 35% 30%, oklch(0.94 0.03 60), oklch(0.76 0.06 50))" }}
          />
          <div
          ...
          <div className="absolute inset-x-5 bottom-5 text-white">
            <p className="font-display text-xl font-semibold tracking-[-0.01em] drop-shadow">{advisor.name}</p>
